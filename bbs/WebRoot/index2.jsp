...
<script>
    ...
    $("#ft").click(function(){
        ...
        if(userInfo != "" && userInfo != null){
            window.location.href="<%=request.getContextPath()%>/publish_post.jsp";
        }else{
        ...
        $("#fk").click(function(){
            var userInfo="${sessionScope.username}";
            if(userInfo != "" && userInfo != null){
                window.location.href="<%=request.getContextPath()%>/pages/advice.jsp";
            }else{
                window.location.href="<%=request.getContextPath()%>/login.jsp";
            }
        });
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <ul class="list-group">
                <div class="list-group-item active">
                    论坛公告
                    <a href="<%=request.getContextPath() %>/more.action?type=-4&&page=1" style="float: right;color: white">更多>></a>
                </div>
                  <%
               ...
               <button id="ft" type="button" class="btn btn-primary" style="width: 200px;height:50px;margin-left: 30px;margin-bottom: 15px">我要发帖</button>
            <button id="fk" type="button" class="btn btn-primary" style="width: 200px;height:50px;margin-left: 30px">我要反馈</button>
        </div>

        <div class="row">
            <div class="col-md-9" style="margin-left: 15px;width: 877.5px">
                <ul class="list-group">
                    <div class="list-group-item active">
                        精华帖
