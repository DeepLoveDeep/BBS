...
<nav class="navbar navbar-inverse" role="navigation">
    ...
    <ul class="nav navbar-nav navbar-right user">
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li ><a href="<%=path%>/login.jsp">我是用户</a></li>
                <li  ><a href="<%=path%>/manage/admin.jsp">我是管理员</a></li>
            </ul>
        </li>
    ...
    <ul class="nav navbar-nav navbar-right user">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="divider"></li>
                <li><a href="<%=path+"/logout.action"%>">退出登录</a></li>
            </ul>
        </li>
    </ul>
    ...
    <ul class="nav navbar-nav navbar-right user">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li ><a href="<%=path%>/manage/excpost.jsp">查看异常帖</a></li>
                <li ><a href="<%=path%>/manage/advice.jsp">查看反馈</a></li>
